...
class MultiPolygon(Model):
    ...
    """
    def __init__(self, type: str=None, coordinates: List[List[List[Point3D]]]=None):  # noqa: E501
        ...
        :type coordinates: List[List[List[Point3D]]]
        """
        self.swagger_types = {
            'type': str,
            'coordinates': List[List[List[Point3D]]]
        }
    ...
    @property
    def coordinates(self) -> List[List[List[Point3D]]]:
        """Gets the coordinates of this MultiPolygon.


        :return: The coordinates of this MultiPolygon.
        :rtype: List[List[List[Point3D]]]
        """
        return self._coordinates

    @coordinates.setter
    def coordinates(self, coordinates: List[List[List[Point3D]]]):
